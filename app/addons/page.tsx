                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-colors ${
                      formData.category === "drink"
                        ? "border-[#A61F30] bg-#F5E6E8 text-[#A61F30]"
                        : "border-border bg-white text-muted-foreground hover:border-[#F1646E]"
                    }`}
                  >
      ...
      <main className="flex-1 p-4 pt-20 lg:pt-6 lg:p-6">
        ...
        {filteredAddOns.length === 0 ? (
          <div className="text-center py-12">
            ...
            <button
              onClick={handleAdd}
              className="inline-flex items-center gap-2 px-5 py-3 bg-[#A61F30] hover:bg-[#8B1826] text-white font-semibold rounded-lg transition-colors"
            >
              <Plus className="h-5 w-5" />
            ...
            {filteredAddOns.map((addOn) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-lg font-bold text-[#A61F30] ml-2">
                ...
                <div className="flex gap-2 justify-end mt-3 pt-3 border-t border-border">
                  <button
                    ...
                    className="p-2 hover:bg-#F5E6E8 rounded-lg transition-colors"
                    title="Edit"
                  >
                    <Pencil className="h-4 w-4 text-[#8B1826]" />
                  </button>
                  <button
